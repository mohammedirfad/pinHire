...
const MOCK_JOBS = [
  ...
  },
  {
    ...
    postedAt: new Date('2026-08-09T08:30:00Z'),
    expiresAt: new Date('2026-09-09T08:30:00Z'),
    status: 'ACTIVE',
    source: 'manual',
    createdBy: 'admin',
  },
  {
    ...
    postedAt: new Date('2026-08-07T14:15:00Z'),
    expiresAt: new Date('2026-09-07T14:15:00Z'),
    status: 'ACTIVE',
    source: 'manual',
    createdBy: 'admin',
  },
  {
    ...
    expiresAt: new Date('2026-09-06T09:00:00Z'),
    status: 'ACTIVE',
    source: 'manual',
    createdBy: 'admin',
  },
  {
    ...
    postedAt: new Date('2026-08-05T16:00:00Z'),
    expiresAt: new Date('2026-09-05T16:00:00Z'),
    status: 'ACTIVE',
    source: 'manual',
    createdBy: 'admin',
  },
  {
    ...
    postedAt: new Date('2026-08-04T11:20:00Z'),
    expiresAt: new Date('2026-09-04T11:20:00Z'),
    status: 'ACTIVE',
    source: 'manual',
    createdBy: 'admin',
  },
  {
    ...
    postedAt: new Date('2026-08-03T15:00:00Z'),
    expiresAt: new Date('2026-09-03T15:00:00Z'),
    status: 'ACTIVE',
    source: 'manual',
    createdBy: 'admin',
  },
  {
    ...
    postedAt: new Date('2026-08-02T13:45:00Z'),
    expiresAt: new Date('2026-09-02T13:45:00Z'),
    status: 'ACTIVE',
    source: 'manual',
    createdBy: 'admin',
  }
...
async function main() {
  console.log('Seeding Pinhire database via JS runner...');
  ...
  console.log('Successfully seeded database with 8 companies and 8 jobs!');
}
